...
object ColorUtil {
    ...
    private val dyeColorToDisplayName = mutableMapOf<DyeColor,String>()
    ...
    init {
        ...
        for (color in ChatColor.values()) {
            ...
            this.colorToDisplayName[color] = WordUtils.capitalizeFully(color.name.lowercase().replace("_"," "))
        }

        for (color in DyeColor.values()) {
            this.dyeColorToDisplayName[color] = WordUtils.capitalizeFully(color.name.lowercase().replace("_"," "))
        }
    }
    ...
    fun getName(color: DyeColor):String {
        return dyeColorToDisplayName[color]!!
    }
    ...
    @JvmStatic
    fun getChatColor(color: DyeColor):ChatColor {
        return dyeColorToColor[color] ?: ChatColor.WHITE
    }
