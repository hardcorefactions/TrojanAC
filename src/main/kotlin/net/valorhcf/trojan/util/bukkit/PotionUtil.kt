...
object PotionUtil {
    ...
    private val namesToType = hashMapOf<String,PotionEffectType>()
    ...
    init {
        ...
        for ((key,value) in this.names) {
            ...
            this.namesToType[lowercase.replace(" ","")] = key
            this.namesToType[lowercase.replace(" ","_")] = key
        }
    ...
    fun getByName(name: String):PotionEffectType? {
        return this.namesToType[name.lowercase()]
    }
